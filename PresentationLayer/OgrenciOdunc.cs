...
{
    public partial class OgrenciOdunc : Form
    {
        public OgrenciOdunc()
        {
            InitializeComponent();
        ...
        private void odunc_listesini_goster()
        {
            ...
            else
            {
                ...
                dataGrid_odunc.Columns[0].Width = 100;
                dataGrid_odunc.Columns[1].Width = 100;
                dataGrid_odunc.Columns[2].Width = 100;
                dataGrid_odunc.Columns[3].Width = 200;
                dataGrid_odunc.Columns[4].Width = 200;
                dataGrid_odunc.Columns[5].Width = 120;
        ...
        private void OgrenciOdunc_Load(object sender, EventArgs e)
        {
        ...
        // form alta inecek
        private void AltaAlClick(object sender, EventArgs e)
        {
        ...
        private void dataGrid_odunc_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (!btn_kitapAra.Visible)
            {
                ...
                dataGrid_odunc.DataSource = businessManager.kitap_ara(dataGrid_odunc.CurrentRow.Cells[2].Value.ToString()).Tables[0];
                // book.check kontorl et ve kitaptan zaten varsa güncelleme !!!!!!!!!!!!!!!!!
                kitapGoruntule.label_id.Text = dataGrid_odunc.CurrentRow.Cells[0].Value.ToString();
                kitapGoruntule.ShowDialog();
