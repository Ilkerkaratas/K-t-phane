...
namespace PresentationLayer
{
    public partial class kitapodunc : Form
    {
        ...
        private void grid_renkleri_degistir(DataGridView dataGridView)
        {
            ...
            {
                DataGridViewCellStyle renk = new DataGridViewCellStyle(); // İstediğiimiz renkleri atayacağımız nesne

                if (!(dataGridView.Rows[i].Cells["odunc_teslim_tarihi"].Value.ToString()).Equals("Teslim edilmedi"))
                {// Eğer öğrenci kitabı teslim ettiyse
                    renk.BackColor = Color.FromArgb(52,80,120); // yeşil tonu arka plan
        ...
        private void odunc_listesini_goster() // tekrar tekrar kullanacağımız için metot olarak yazdık. gerektiğinde kullanacaz.
        {
            ...
            else
            {
                ...
                dataGrid_odunc.Columns[0].Width = 160;
                dataGrid_odunc.Columns[1].Width = 160;
                dataGrid_odunc.Columns[2].Width = 160;
                dataGrid_odunc.Columns[3].Width = 160;
                dataGrid_odunc.Columns[4].Width = 160;
                dataGrid_odunc.Columns[5].Width = 160;
    ...
    private void btn_ogrenciAra_Click(object sender, EventArgs e)
        ...
        private void dataGrid_odunc_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                Ogrenci fStudentOne = new Ogrenci();
